    ...
    public class TrackNode : MonoBehaviour, INode
    {
        ...
        public void CalculateLenghtAndNormals()
        {
            ...
            if (previousSegment != null)
                previousSegment.TrackSegment.calculateLengthAndNormals();

            if (nextSegment != null)
                TrackSegmentModify.TrackSegment.calculateLengthAndNormals();

            if (nextSegment != null)
                nextSegment.TrackSegment.calculateLengthAndNormals();
        }
    }
}